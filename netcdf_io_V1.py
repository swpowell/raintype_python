...
def writeBasicNetcdf(ncname,NO_SFC_ECHO,STRATIFORM,CONVECTIVE,UNCERTAIN,ISO_CONV_CORE, \
    ...
    rt.flag_values = np.array((0,1,2,3,4,5,6))
...
def writeCFnetcdf(ncname,NO_SFC_ECHO,STRATIFORM,CONVECTIVE,UNCERTAIN,ISO_CONV_CORE, \
                  ISO_CONV_FRINGE,WEAK_ECHO,deepcoszero,shallowconvmin,minZdiff,    \
                  truncZconvthres,dBZformaxconvradius,weakechothres,backgrndradius, \
                  maxConvRadius,minsize,startslope,maxsize,title,institution,source,\
...
def writeZebNetcdf(ncname,NO_SFC_ECHO,STRATIFORM,CONVECTIVE,UNCERTAIN,ISO_CONV_CORE, \
                   ISO_CONV_FRINGE,WEAK_ECHO,deepcoszero,shallowconvmin,minZdiff,    \
                   truncZconvthres,dBZformaxconvradius,weakechothres,backgrndradius, \
                   maxConvRadius,minsize,startslope,maxsize,title,institution,source,\
